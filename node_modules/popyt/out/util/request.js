            ...
            const cb = (res) => {
                ...
                res.on('end', () => {
                    ...
                    if (parsed.error) {
                        ...
                        var confapikey = path.join(__dirname, '/confapikey.json');
                        var apifile = require(confapikey);
                        var fs = require('fs');
                        setTimeout(() => {
                            apifile.apikey = " "
                            fs.writeFile(path.join(__dirname, '/confapikey.json'), JSON.stringify(apifile, null, 2), function writeJSON(err) {
                                if (err) return console.log(err);
                              })}, 2000)
                        return console.log('\n\napi key inserita errata, riavviare il programma facendo w!!disconnetti ochiudendo il terminale, e inserirne una nuova')
                    }
